...
SELECT product_id, product_name, category_name, total_sold_quantity, 
       total_sales_revenue, estimated_profit, turnover_percentage
...
SELECT category_name, total_products, total_sales_revenue, 
       gross_profit, profit_margin_percent, market_share_percent
